...
const userNavigation = [
    ...
    { name: 'Sign out', href: '#', onClick: () => void signOut() },
]
                            ...
                            <Disclosure.Panel className="sm:hidden">
                                ...
                                <div className="border-t border-gray-200 pb-3 pt-4">
                                    <div className="flex items-center px-4">
                                        ...
                                        <div className="ml-3">
                                            <div className="text-base font-medium text-gray-800">{sessionData?.user.name}</div>
                                            <div className="text-sm font-medium text-gray-500">{sessionData?.user.email}</div>
                                        </div>
                                        <button
                                            type="button"
